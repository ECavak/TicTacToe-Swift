...
//  TicTacToe
//
//  Created by Emre Cavak on 12.11.2022.
//
    ...
    var body: some View {
        VStack {
            ...
            Alert(title: Text("Game Over"),
                  message: Text(self.ticTacToeModel.gameOver.0 != .empty ? self.ticTacToeModel.gameOver.0 == .home ? "Kazandın!" : "AI Kazandı" : "Berabere" ), dismissButton: Alert.Button.destructive(Text("Tamam"), action: {
